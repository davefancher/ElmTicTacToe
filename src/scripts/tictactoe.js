			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						function () {
							var _p0 = model.lastMoveResult;
							switch (_p0.ctor) {
								case 'InvalidMove':
									return 'Invalid Move! Try again.';
								case 'NextMove':
									if (_p0._0.ctor === 'PlayerX') {
										return 'X\'s Turn';
									} else {
										return 'O\'s Turn';
									}
...
var _user$project$TicTacToe$replaceCell = F2(
	function (board, newCell) {
		return A2(
			_elm_lang$core$List$map,
			function (oldCell) {
				return _elm_lang$core$Native_Utils.eq(oldCell.position, newCell.position) ? newCell : oldCell;
			},
			board);
	});
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('glyphicon glyphicon-refresh')
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
...
var _user$project$TicTacToe$buildCell = F2(
	function (model, cell) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('col-sm-4 text-center')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					function () {
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('tic-tac-toe-board')
						]),
					A2(
						_elm_lang$core$List$map,
